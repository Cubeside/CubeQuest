...
public class QuestStatusShopItemConditionType extends ShopItemConditionType<QuestStatusShopItemCondition> {
    ...
    public QuestStatusShopItemCondition createCondition(CommandSender sender, ArgsParser args, String commandPrefix)
        ...
        try {
            description = args.hasNext() ? ComponentUtilAdventure.convertEscaped(args.getAll(null)) : null;
        } catch (ParseException e) {
            throw new IllegalConditionDataException("Ungültige Beschreibung: " + e.getMessage());
        }
