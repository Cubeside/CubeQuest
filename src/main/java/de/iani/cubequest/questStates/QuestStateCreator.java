...
public class QuestStateCreator {
     ...
     * catch (SQLException e) { CubeQuest.getInstance().getLogger().log(Level.SEVERE,
     * "Could not load quest with id " + id, e); return null; }
     * 
     ...
     * }
     * 
     * public void refreshQuest(int id) { Quest quest =
     ...
     * 
     * try { CubeQuest.getInstance().getDatabaseFassade().updateQuest(id, serialized); } catch
     * (SQLException e) { CubeQuest.getInstance().getLogger().log(Level.SEVERE,
     * "Could not update quest with id " + id + ":\n" + serialized, e); } }
     * 
     * public void updateQuest(int id) { Quest quest =
     * CubeQuest.getInstance().getQuestManager().getQuest(id); if (quest == null) { throw new
     * NullPointerException("Quest does not exist!"); } updateQuest(quest); }
     */
}
