...
public class DatabaseFassade {
    ...
    public record SimplePlayerData(int questPoints, int xp, long dailyQuestStreakStart, long dailyQuestStreakEnd) {}

    public SimplePlayerData getPlayerData(UUID id) throws SQLException {
        return this.playerDB.getPlayerData(id);
    }

    public void setPlayerData(UUID id, int questPoints, int xp, long dailyQuestStreakStart, long dailyQuestStreakEnd)
            throws SQLException {
        this.playerDB.setPlayerData(id, questPoints, xp, dailyQuestStreakStart, dailyQuestStreakEnd);
    }
