...
public class ClickInteractorQuestSpecification extends DifficultyQuestSpecification {
    ...
    public ClickInteractorQuest createGeneratedQuest(String questName, Reward successReward) {
        ...
        ClickInteractorQuest result = new ClickInteractorQuest(questId, questName, null, CubeQuest.PLUGIN_TAG + ChatColor.GOLD + " " + getGiveMessage(), CubeQuest.PLUGIN_TAG + ChatColor.GOLD + " " + getSuccessMessage(), successReward, getInteractor());
    ...
    public BaseComponent[] getSpecificationInfo() {
        return new ComponentBuilder("").append(super.getSpecificationInfo())
                .append(ChatColor.DARK_AQUA + " Interactor: " + ChatAndTextUtil.getInteractorInfoString(dataStorageQuest.getInteractor()))
