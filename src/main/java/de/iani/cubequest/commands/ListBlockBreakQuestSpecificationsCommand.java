...
public class ListBlockBreakQuestSpecificationsCommand extends SubCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String alias, String commandString,
        ...
        List<Component> list = QuestGenerator.getInstance().getBlockBreakSpecificationInfo();
        if (list.isEmpty()) {
            ChatAndTextUtil.sendNormalMessage(sender, "Es gibt keine Block-Abbau-Quest-Materialkombinationen.");
            return true;
        }

        ChatAndTextUtil.sendMessagesPaged(sender, list, args.getNext(1) - 1, "Block-Abbau-Quest-Materialkombinationen",
