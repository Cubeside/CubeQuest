    ...
    public boolean onCommand(CommandSender sender, Command command, String alias,
        ...
        if (list.isEmpty()) {
            ChatAndTextUtil.sendNormalMessage(sender,
                    "Es gibt keine Block-Platzier-Quest-Materialkombinationen.");
            return true;
        }
        
        ChatAndTextUtil.sendMessagesPaged(sender, ChatAndTextUtil.bcToSendableList(list),
                args.getNext(1) - 1, "Block-Platzier-Quest-Materialkombinationen",
                "/quest listBlockPlaceQuestSpecifications");
