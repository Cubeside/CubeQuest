...
public class AddOrRemoveIncreaseStatisticQuestSpecificationCommand extends SubCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String alias, String commandString,
        ...
        Pair<String, String> descriptionsRaw = StringUtil.splitAtPipe(rest);
        if (descriptionsRaw == null || descriptionsRaw.second().isEmpty()) {
            ChatAndTextUtil.sendWarningMessage(sender,
                    "Bitte gib Beschreibungen für Fließtext (Buch) und Fortschrittsanzeige an, getrennt von durch \" | \".");
            return true;
        }
        ...
        IncreaseStatisticQuestPossibility statisticPossibility =
                new IncreaseStatisticQuestPossibility(key, weight, maxOnce, textDesc, progressDesc);
