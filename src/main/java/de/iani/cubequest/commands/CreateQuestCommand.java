...
public class CreateQuestCommand extends SubCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String alias, String commandString,
        ...
        idComponent.setClickEvent(new ClickEvent(ClickEvent.Action.COPY_TO_CLIPBOARD, String.valueOf(id)));
        idComponent.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text("ID kopieren")));
        ChatAndTextUtil.sendNormalMessage(sender, type, " mit Quest-ID ", idComponent, " erfolgreich erstellt.");
