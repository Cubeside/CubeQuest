 ...
 * <p>
 * Handles the parsing of different argument/parameter types. Parameter
 * constraints and the action to be performed when they are met are specified in
 * the constructor.
 * 
 * @author Jonas Becker
 *
...
public abstract class AssistedSubCommand extends SubCommand {
    ...
    public enum ParameterType {
        ...
        /**
         * The quest currently edited by the command sender, if he currently edits a
         * quest. A single quest, specified by name or id, otherwise
         */
     ...
     * <p>
     * A parameter is definde by it's type, it's name and the constraint it shall
     * respect.
     * 
     * @author Jonas Becker
     *
    ...
    public static class ParameterDefiner {
         ...
         * <p>
         * After the parameter's value is successfully optained, it's constraint is
         * invoked. The passed array contains the command sender followed by all values
         * optained until now in the order their parameters were defined in. If the new
         * value fullfills the constraint, it shall return {@code null}. Otherwise, it
         * shall return the error message to be send to the command sender.
         * 
         * @param type
         *            this parameters ParameterType (may not be ENUM)
         * @param name
         *            this parameters name
         * @param constraint
         *            the condition this parameter shall fullfill
         */
     ...
     *
     * @param <T>
     *            the enum class from which a value is to be optained
     */
     ...
     * <p>
     * Differs from an IllegalArgumentException in the way that it's checked and
     * should never leave this class.
     * 
     * @author Jonas Becker
     *
     */
