...
public class SetGotoInvertedCommand extends AssistedSubCommand {
    
    public static final String COMMAND_PATH = "setGotoInverted";
    ...
    static {
        ...
        propertySetter = parsed -> {
            ((GotoQuest) parsed[1]).setInverted((Boolean) parsed[2]);
            return null;
        };
