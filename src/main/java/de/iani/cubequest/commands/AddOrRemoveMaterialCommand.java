...
public class AddOrRemoveMaterialCommand extends SubCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String alias, String commandString,
        ...
        if (!args.hasNext()) {
            ...
            if (material == null) {
                ChatAndTextUtil.sendWarningMessage(sender, "Bitte gib an, welches Material " + (add? "zu" : "von") + " der Quest " + (add? "hinzugefügt" : "entfernt") + " werden soll (oder, als Spieler: Nimm es in die Hand).");
                return true;
            }
        } else {
