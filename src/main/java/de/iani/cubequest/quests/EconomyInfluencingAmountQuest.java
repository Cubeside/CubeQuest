...
public abstract class EconomyInfluencingAmountQuest extends AmountQuest {
    ...
    public EconomyInfluencingAmountQuest(int id, String name, Component displayMessage, int amount) {
        super(id, name, displayMessage, amount);
        init();
    }

    public EconomyInfluencingAmountQuest(int id, String name, Component displayMessage) {
